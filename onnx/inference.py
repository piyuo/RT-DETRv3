...
def parse_args():
    ...
    ap.add_argument("--model", default="onnx/output/rtdetrv3_r18vd_6x.onnx")
    ap.add_argument("--image", default="onnx/demo/demo.jpg")
    ap.add_argument("--out", default="onnx/validation/demo_inference.jpg")
